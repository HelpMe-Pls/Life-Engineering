...
- Promises could default to reporting (to the developer console) any rejection, on the next [[Async#Jobs  |Job]] or event loop tick, if at that exact moment no error handler has been registered for the Promise.
