...
- With CCs, you have to prepare all possibilities that your JSON might return, bloating your code with ternary JSXs and therefore reducing readability. So, the biggest benefit that SCs offer is they take away the burden of relying on JSON that CCs depend on to render the UI. 
