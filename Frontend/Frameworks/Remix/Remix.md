- Remix is actually a [fullstack framework](https://remix.run/docs/en/main/discussion/introduction). We can explicitly label a module as server-only by creating a file with `.server` in the name.
