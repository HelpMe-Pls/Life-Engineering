...
## September → November — repeat weekly (~10h/wk): the delivery months
...
- [ ] 🥈 Mon Nov 30, 30m: count deposits; read the verdict EXACTLY as written in [[Antifragile SaaS]] §4. No renegotiating with yourself.
- [ ] 🥉 Sun Dec 13, 30m: count paying subscribers; verdict per [[Duty SaaS]] §5.
...
## Calendar these 9 dates now
1. Fri Jul 24 — surcharge dies (the Ledger's first big recording)
2. Mon Aug 3 — EP outreach begins
3. Tue Sep 1 — Clock cold outreach opens
4. Tue Sep 8 — EP deposits target
5. Sun Sep 13 — EP enrollment closes
6. Mon Sep 21 — cohort 1 starts
7. Mon Nov 30 — Clock verdict
8. Mon Dec 7 — cohort 2 starts
9. Sun Dec 13 — Ledger verdict

## Feedback loop — how this section works with Claude
- The three runbooks ([[EP SaaS]], [[Antifragile SaaS]], [[Duty SaaS]]) are the LAW: gates, firewalls, settled blocks, Black Swan ledgers. This `# Venture` section is the SCHEDULE: action items here adapt freely as reality punches back.
- Write observations under "Notes to the consultant" below — dated, raw, bullet-style: what happened, what a customer said verbatim, what broke, what pulled. ==No essays. If a note turns into analysis, that's the green-lumber trap — close the file and send the next ask instead.==
- Any Claude session asked to adapt this plan must: read this whole `# Venture` section plus the runbook sections it cites; treat the runbooks' gates and settled blocks as movable ONLY via their own firewall signals (never via mood, mine included); keep every proposed change inside the hour ceiling and the cut order; and ==call out analysis-as-procrastination whenever it appears in my notes — that is part of the job, not rudeness.==
